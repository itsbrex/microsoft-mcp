...
- Repository: [universal-tool-calling-protocol/code-mode](https://github.com/universal-tool-calling-protocol/code-mode)
- Description: 🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution.
- Default branch: `main`
...
- Forks: 96
- Open issues: 9
- Clone URL: `https://github.com/universal-tool-calling-protocol/code-mode.git`
...
2. Audit the code in the cloned copy.
3. Use the README below as orientation before digging into the code.

```bash
git clone --depth=1 https://github.com/universal-tool-calling-protocol/code-mode.git /tmp/code-mode
```

If shell access is not available:

- Use the README and metadata below.
- Fall back to the GitHub web UI for file browsing.
